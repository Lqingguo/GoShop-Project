<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="isShowBrief = !isShowBrief">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowSheet =!isShowSheet">
      <div class="discounts-left">
        <div class="activity activity-green" :class="activitya[info.supports[0].type]">
          <span class="content-tag">
    ...
    <transition name="pade">
      <div class="shop-brief-modal" v-if="isShowBrief">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="isShowBrief = !isShowBrief">
    ...
    <div class="activity-sheet" v-if="isShowSheet">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">
          优惠活动</h2>
        <ul class="list">
          <li class="activity-item" :class="activitya[support.type]" v-for="(support,index) in info.supports" :key="index">
            <span class="content-tag">
        ...
        <div class="activity-sheet-close" @click="isShowSheet =!isShowSheet">
          <span class="iconfont icon-close" ></span>
        </div>
      </div>
...
<script>
  ...
  export default {
    data(){
      return{
        activitya:['activity-green','activity-red','activity-orange'],
        isShowBrief:false,
        isShowSheet:false
      }
    }
